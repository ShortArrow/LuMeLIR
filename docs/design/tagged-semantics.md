...
5. **`__newindex` write-path metamethod.** **RESOLVED by [ADR 0135](0135-metatables-newindex-write.md) (2026-05-31)** for the hash-key Table form. Function-form `__newindex`, `rawset` builtin, Number-key (array) `__newindex` remain deferred per ADR 0133.
