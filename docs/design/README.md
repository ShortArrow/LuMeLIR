...
- [0253 — lua54-preferred-subset-declaration](0253-lua54-preferred-subset-declaration.md) — M17 (closing) declaration. Formal Lua 5.4 preferred-subset conformance statement: §-by-§ status table of every spec item (✅ shipped vs. ⏸ deferred-with-strategy). 253 total ADRs landed; 1617 tests; zero regression across the M1-M16 sweep. LuMeLIR is a shippable Lua 5.4 preferred-subset AOT compiler.
