# 0299. `select` over the vararg pack (F1-D partial)

- **Status:** Accepted (vararg-pack form; general `select(n, a, b, c)` deferred)
...
5 e2e (`tests/phase4_f1d_select.rs`): count 3; count 0 (no extras); n-th extra; past-end nil; declared-params-first split. Suite 1807 → 1812.
