...
| ‣ 2.6+ tables / metatables | In progress | tag-dispatch skeleton extraction, tagged-callee arity hardening, multi-return × TaggedValue, indirect tagged-return, closure-with-upvalues, arith coerce, iteration, methods, metatables — multiple sub-phases |
