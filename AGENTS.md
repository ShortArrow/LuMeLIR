...
| ‣ 2.6+ tables / metatables | In progress | tagged-callee arity hardening, multi-return × TaggedValue, indirect tagged-return, closure-with-upvalues, arith coerce, iteration, methods, metatables — multiple sub-phases |
