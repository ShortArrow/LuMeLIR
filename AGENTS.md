...
| ‣ 2.6+ tables / metatables | In progress | pairs hash iteration, future indirect-call re-enablement, full closures, closure-with-upvalues, runtime hash-key diagnostics, methods, metatables — multiple sub-phases |
