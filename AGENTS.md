...
| ‣ 2.6+ tables / metatables | In progress | TaggedValue arith coerce (LIC-2.7p-arith-coerce-tagged-1), Function-kind upvalue support (lifts MutualCapturingRecursion + IndirectCallNonNumberReturn backstops), methods, metatables — multiple sub-phases, future ADRs |
