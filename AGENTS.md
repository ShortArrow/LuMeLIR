...
| ‣ 2.6+ tables / metatables | In progress | future indirect-call re-enablement, full closures, closure-with-upvalues, TaggedValue-key IndexAssign, runtime hash-key diagnostics, methods, metatables — multiple sub-phases |
