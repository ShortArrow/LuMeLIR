...
| ‣ 2.6+ tables / metatables | In progress | function-return widening, tag-dispatch skeleton extraction, closure-with-upvalues escape relaxation, arith coerce, methods, metatables — multiple sub-phases |
