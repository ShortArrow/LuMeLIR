...
| ‣ 2.6+ tables / metatables | In progress | hash key kinds, pairs hash iteration, future indirect-call re-enablement, closure-with-upvalues, methods, metatables — multiple sub-phases |
