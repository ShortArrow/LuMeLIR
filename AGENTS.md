...
| ‣ 2.6+ tables / metatables | In progress | iteration, hash key kinds, future indirect-call re-enablement, closure-with-upvalues, methods, metatables — multiple sub-phases |
