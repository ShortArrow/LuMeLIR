...
| ‣ 2.6+ tables / metatables | In progress | general indirect-call re-enablement (ADR 0082 Plan B Beta), full closures, closure-with-upvalues, TaggedValue-key IndexAssign, runtime hash-key diagnostics, methods, metatables — multiple sub-phases |
