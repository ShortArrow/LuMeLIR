...
| ‣ 2.6+ tables / metatables | In progress | full closures, closure-with-upvalues, generic-for protocol (LIC-2.8e-iter-generic-1; ADR 0082 unblocks codegen), TaggedValue-key IndexAssign, runtime hash-key diagnostics, methods, metatables — multiple sub-phases |
