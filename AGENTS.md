...
| ‣ 2.6+ tables / metatables | In progress | TaggedValue arith coerce (ADR 0088 candidate), hash-missing-key read return-nil (LIC-2.6b-hash-missing-key-read-1), methods, metatables — multiple sub-phases |
