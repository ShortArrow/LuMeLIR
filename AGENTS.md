...
| ‣ 2.6+ tables / metatables | In progress | full closures (ADR 0083 deferred), closure-with-upvalues, generic-for protocol (LIC-2.8e-iter-generic-1; ADR 0082 unblocks codegen), runtime hash-key NaN diagnostic, methods, metatables — multiple sub-phases |
