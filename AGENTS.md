...
| ‣ 2.6+ tables / metatables | In progress | function-call through tagged slot, function-return widening, closure-with-upvalues escape relaxation, tagged module split (Tidy First), arith coerce, methods, metatables — multiple sub-phases |
