...
| ‣ 2.6+ tables / metatables | In progress | Function-kind upvalue support (lifts MutualCapturingRecursion + IndirectCallNonNumberReturn backstops), methods, metatables — multiple sub-phases, future ADRs. Phase 2 tagged-semantics consumer coverage complete as of ADR 0089. |
